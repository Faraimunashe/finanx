    ...
    <div class="bg-green-50 flex items-center justify-center h-screen">
        <div class="bg-white shadow-2xl rounded-2xl p-10 max-w-md w-full">
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <button type="submit" :disabled="form.processing" class="bg-green-700 text-white py-4 px-10 rounded-full font-bold shadow-lg w-full hover:bg-green-800 transition-all">Login</button>
            </form>
