<template>
  <div v-if="show && transaction" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
...
// Watch for transaction changes and populate form
watch(() => props.transaction, (newTransaction) => {
  if (newTransaction) {
    form.account_id = newTransaction.account_id;
    form.currency_id = newTransaction.currency_id;
    form.type = newTransaction.type;
    form.amount = newTransaction.amount;
    form.description = newTransaction.description || '';
    form.transaction_date = newTransaction.transaction_date;
  }
}, { immediate: true });
